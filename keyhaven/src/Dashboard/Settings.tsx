...
export const Settings = () => {
    ...
    return (
        <>
            <MyAlert isVisible={showPassAlert} setInvisible={() => setShowPassAlert(false)} content="An email has been sent to you to change the password!"/>
            <MyAlert isVisible={showVerifyAlert} setInvisible={() => setShowVerifyAlert(false)} content="An email has been sent to you for verification!"/>
