    ...
    return (
        <div className="flex bg-gray-100 justify-center px-4">
            <div className="flex p-20 bg-gray-200 mb-20 rounded-xl shadow-xl border border-default1 align-middle w-custom2 justify-between">
                ...
                <div><img className="aspect-square w-80 rounded-lg object-cover" src={headshot}/></div>
            </div>
        </div>
    )
}